...
<head>
    ...
    $(document).ready(function() {
        $('.shalini_buy').click(function() {
            swal("Join required to order!", "!", "error");
        });
    });
    </script>
</head>
...
<body>
    ...
    $(document).ready(function() {
        $('.ds').waypoint(function(direction) {
            $('.ds').addClass('animated zoomInLeft')
        }, {
            offset: '50%'
        });
        $('.df').waypoint(function(direction) {
            $('.df').addClass('animated zoomInRight')
        }, {
            offset: '50%'
        });
        $('.sa').waypoint(function(direction) {
            $('.sa').addClass('animated zoomInRight')
        }, {
            offset: '0%'
        });
    });
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card bg-light mb-3">
                    ...
                    <ul class="list-group category_block ds">
                        <li class="list-group-item active"><a href="category.html" class=" text-white">Indian Foods</a>
                        </li>
                        <li class="list-group-item"><a href="category.html">Chinese Foods</a></li>
                        <li class="list-group-item"><a href="category.html">Fast Food</a></li>
                        <li class="list-group-item"><a href="category.html">Family Fare</a></li>
                        <li class="list-group-item"><a href="category.html">Buffets</a></li>
                    </ul>
                </div>
                <div class="card bg-light mb-3 df">
                    ...
                    <div class="card-body">
                        ...
                        <p class="bloc_left_price">11.00 $</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-9">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="product-grid2">
                                <div class="product-image2">
                                    ...
                                    <button class="shalini_buy add-to-cart" href="">Order Now</button>
                                </div>
                                <div class="product-content">
                                    <h3 class="title"><a href="#"><?php echo $shalu_fetch_data['item_name']; ?></a></h3>

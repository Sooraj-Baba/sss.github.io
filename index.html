...
<body>
    ...
    $(document).ready(function() {
        ...
        $('.sha1').waypoint(function(direction) {
            $('.sha1').addClass('animated zoomInLeft')
        }, {
            offset: '60%'
        });
        $('.sha4').waypoint(function(direction) {
            $('.sha4').addClass('animated zoomInRight')
        }, {
            offset: '60%'
        });
        $('.sha2').waypoint(function(direction) {
            $('.sha2').addClass('animated zoomInDown')
        }, {
            offset: '60%'
        });
        $('.sha3').waypoint(function(direction) {
            $('.sha3').addClass('animated zoomInDown')
        }, {
            offset: '60%'
        });
        ...
        $('.cardss3').waypoint(function(direction) {
            $('.cardss3').addClass('animated bounceInRight')
        }, {
            offset: '60%'
        });
        $('.cardss2').waypoint(function(direction) {
            $('.cardss2').addClass('animated bounceInUp')
        }, {
            offset: '60%'
        });
    });

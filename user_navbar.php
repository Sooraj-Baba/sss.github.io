 <nav class="shalini_navbar navbar navbar-expand-lg navbar-dark">
     <a class="navbar-brand font-bold" href="userindex.php" style="color:white; font-family: 'Fugaz One', cursive;
">Shalini Resturent.</a>
     ...
     <div class="collapse navbar-collapse pl-5 pr-5" id="navbarText1">
         <ul class="sss navbar-nav m-auto animated bounceInLeft" style="font-family: 'Amaranth', sans-serif;">
             <li class="nav-item">
                 <a class="nav-link waves-effect waves-light" href="userindex.php">Home<span
                         class="sr-only">(current)</span></a>
             </li>
             <li class="nav-item">
                 <a class="nav-link waves-effect waves-light" href="user_categories.php">Categories</a>
             </li>
             <li class="nav-item">
                 <a class="nav-link waves-effect waves-light" href="user_foods.php">Foods</a>
             </li>
             <li class="nav-item">
                 <a class="nav-link waves-effect waves-light" href="user_about.php">About Us</a>
             </li>
             <li class="nav-item">
                 <a class="nav-link waves-effect waves-light" href="user_contact.php">Contact</a>
             </li>
         ...
         <ul class="nav navbar-nav navbar-right ml-auto">
             ...
             <li class="nav-item dropdown">
                 <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img
                         src="<?php echo $_SESSION['userimage']; ?>" alt="Avatar"> <?php echo $_SESSION['username']; ?>
                     <b class="caret"></b></a>

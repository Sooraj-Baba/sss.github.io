...
<body>
    ...
    $(document).ready(function() {
        $('.see').waypoint(function(direction) {
            $('.see').addClass('animated zoomInLeft')
        }, {
            offset: '50%'
        });
        $('.srr').waypoint(function(direction) {
            $('.srr').addClass('animated zoomInRight')
        }, {
            offset: '50%'
        });
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 m-auto srr">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 m-auto see">
                <h2><span>Our Foods <b>Item</b></span></h2>
                <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="0">
                    <!-- Carousel indicators -->
                    <ol class="carousel-indicators">

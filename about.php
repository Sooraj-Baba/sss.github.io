    ...
    <div class="container">
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    $(document).ready(function() {
                        $('.sdds').waypoint(function(direction) {
                            $('.sdds').addClass('animated fadeInLeft')
                        }, {
                            offset: '240px'
                        });
                    ...
                    <div class="carousel-inner">
                        <div class="item carousel-item active">
                            <div class="row">
                                <div class="col-sm-6 animated zoomInLeft">
                                    <div class="testimonial">
                                        <p>Shalini singh a web developer is a programmer who specializes in, or is
                                            specifically
                                ...
                                <div class="col-sm-6 animated zoomInRight">
                                    <div class="testimonial">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="overview">
                                                <div class="name"><b>Shilpi Singh</b></div>
        ...
        <div id="about" class="container">
            <div class="row">
                ...
                <div class="col-sm-4 ">
                    <span class="m-auto "><img src="images/shs.png" class="smm img-fluid m-auto" style="height: 290px;"
                            alt=""></span>
                </div>
            </div>
        </div>
